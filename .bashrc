...
if [ "$color_prompt" = yes ]; then
    PS1='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]universe@\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]\$ '
else
    PS1='${debian_chroot:+($debian_chroot)}universe@\h:\w\$ '
fi
...
case "$TERM" in
xterm*|rxvt*)
    PS1="\[\e]0;${debian_chroot:+($debian_chroot)}universe@\h: \w\a\]$PS1"
    ;;
*)
    ;;
esac
...
case "$TERM" in
	...
	PRE='\[\033[01;32m\]universe@\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]'
	;;
    *)
        PRE='universe@\h:\w'
        ;;
